<?php function thb_postcarousel( $atts, $content = null ) {
  ...
  extract( $atts );
	...
	if ( $posts->have_posts() ) { ?>
		...
		<?php } ?>
		<div class="<?php echo implode(' ', $classes); ?>" data-center="<?php echo esc_attr($center); ?>" data-columns="<?php echo esc_attr($columns); ?>" data-pagination="<?php echo esc_attr($pagi); ?>" data-navigation="<?php echo esc_attr($nav); ?>" data-autoplay="<?php echo esc_attr($autoplay); ?>" data-autoplay-speed="<?php echo esc_attr($autoplay_speed); ?>">
