...
<html>
<head>
<link rel="stylesheet" href="<?php echo Thb_Theme_Admin::$thb_theme_directory_uri; ?>inc/tinymce/shortcode_generator/css/tinymce.css" />
<link rel="stylesheet" href="<?php echo Thb_Theme_Admin::$thb_theme_directory_uri; ?>inc/tinymce/shortcode_generator/css/chosen/chosen.min.css" />
<script src="<?php echo Thb_Theme_Admin::$thb_theme_directory_uri; ?>inc/tinymce/shortcode_generator/js/chosen/chosen.jquery.min.js"></script>
<script src="<?php echo Thb_Theme_Admin::$thb_theme_directory_uri; ?>inc/tinymce/shortcode_generator/js/popup.min.js"></script>
...
<?php echo $shortcode_html . $html_options;  ?>
	...
	<a class="thb-btn" id="add-shortcode"><?php echo esc_html__( 'Add Shortcode', 'thevoux' ); ?></a>
