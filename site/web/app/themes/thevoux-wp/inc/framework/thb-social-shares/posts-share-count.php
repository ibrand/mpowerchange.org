...
if ( ! class_exists( 'BaPSSC' ) ) {
	final class BaPSSC {
		 ...
		 * @since BaPSSC (1.0.0)
		 */
		public function __clone() { _doing_it_wrong( __FUNCTION__, __( 'Cheatin&#8217; huh?', 'thevoux' ), '1.7' ); }
		...
		public function admin_edit_shares() {
			...
			<div class="misc-pub-section curshares misc-pub-curshares">
				<span id="timesshared">
					<span class="dashicons dashicons-share" style="color: #888;"></span> <?php esc_html_e( 'Total Shares', 'thevoux' ); ?>: <b><?php echo get_post_meta( $_GET['post'], 'thb_pssc_counts', true ); ?></b>
				</span>
			</div>
			<?php
			}
