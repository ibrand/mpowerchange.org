					...
					?>
						...
						<?php else: ?>
							<mark class="<?php echo esc_attr($mark); ?>">
									...
									<?php esc_html_e('Required PHP Version is at least 5.6. WordPress <a href="https://wordpress.org/about/requirements/" target="_blank">recommends using at least PHP 7.0.</a> ', 'thevoux'); ?>
							</mark>
						<?php endif; ?>
					<?php	} ?>
				</td>
				...
				<td>
					...
					<?php else: ?>
						<mark class="<?php echo esc_attr($mark); ?>">
								...
								<?php esc_html_e('The recommended value is 30.', 'thevoux'); ?>
						</mark>
					<?php endif; ?>
				...
				<tr>
					...
					<td>
						<mark class="<?php echo esc_attr($mark); ?>">
							...
							<span><?php echo ! empty( $poste['note'] ) ? esc_html( $poste['note'] ) : ''; ?></span>
						</mark>
					</td>
				</tr>
				<?php
