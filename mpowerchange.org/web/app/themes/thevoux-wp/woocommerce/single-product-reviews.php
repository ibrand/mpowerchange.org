	...
	<div class="small-12 medium-10 medium-centered columns">
		...
		<div id="comments">
			...
			<?php else : ?>
				...
				<p class="woocommerce-noreviews"><?php _e( 'There are no reviews yet.', 'thevoux' ); ?></p>
			...
			<?php if ( get_option( 'woocommerce_review_rating_verification_required' ) === 'no' || wc_customer_bought_product( '', get_current_user_id(), $product->get_id() ) ) : ?>
				...
				<div id="review_form_wrapper">
					...
					<?php		
						...
						$comment_form['comment_field'] .= '<div class="row"><div class="small-12 columns"><label for="comment">' . esc_html__( 'Your Review', 'thevoux' ) . '</label><textarea id="comment" name="comment" aria-required="true"></textarea></div></div>';
			...
			<?php else : ?>
				...
				<p class="woocommerce-verification-required"><?php _e( 'Only logged in customers who have purchased this product may leave a review.', 'thevoux' ); ?></p>
